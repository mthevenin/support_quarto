...
* Posit (ex Rstudio) a également ses propres éléments de balisage, ce qui lui permet de proposer un markdown enrichi pour de nombreux éléments de mise en page. Ces nouveautés ont été introduites récemment avec les dernières versions de Rmarkdown. 
...
* En html les listes sont générées avec un système de balises imbriquées ou non (`<ul>`,`<li>`). C'est assez pénible.
