...
**A l'ined [important]**: ce problème de durée de compilation des document est levé si on utilise la version serveur (margaux) de RStudio.... mais on peut rencontrer des problèmes de chargement de certaines librairies R. C'est le cas du packages `questionr` (idem rmarkdown). 
