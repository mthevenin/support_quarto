...
#### Quarto à l'Ined sous serveur margaux

* La durée de compilation est extrêmement rapide.
* On rencontre des problèmes pour charger certains packages R dans un document Quarto (et Rmarkdown). C'est par exemple le cas du package **`questionr`**.
