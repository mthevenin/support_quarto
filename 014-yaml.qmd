...
* Il s'agit du header du document qui comprend toutes les métadonnées du document: titre, date, options de mise en page, options d'exécution.... Dans un document html il s'agit des différentes options entrant dans la partie  **<head> </head>**.
