...
* Reprise des chapitres sur git
  * Ajout de sections sur les conflits et une introduction sur le travail sur branches [chapitres 6 et 7].
  * Simplification de la procédure de connection via une clé SSH
  * Encore en mode draft, un chapitre résumé.
